...
const Hero = () => {
  return (
    <section className='container mx-auto pt-4 text-3xl font-bold grow h-screen grid sm:grid-rows-2 md:grid-cols-2 md:gap-x-8 text-center place-content-center bg-violet-100/80'>
